...
const Messages = require("../models/communicatorModel");
...
const messangerController = {
  createMessage: async (req, res) => {
    try {
      ...
      res.json({ msg: "Stworzono poprawnie" });
    } catch (error) {
...
module.exports = messangerController;
